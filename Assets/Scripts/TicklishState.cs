...
public class TicklishState : IState
{
    ...
    private int _animHash = Animator.StringToHash("Ticklish");

    public TicklishState(PetController pet)
    {
        _pet = pet;
        _anim = pet.GetComponent<Animator>();
        _finishTime = pet.StateFinishTime[(int)EPetState.Ticklish];
    }
    public void Enter()
    {
        Debug.Log("happy진입");
